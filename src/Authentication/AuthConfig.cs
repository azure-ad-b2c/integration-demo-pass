...
namespace B2C.PASSDemo.Authentication
{
    public static class AuthConfig
    {
        private const string AuthenticationPoliciesSectionName = "AuthenticationPolicies";

        public const string AuthTemplateCorsPolicyName = "AuthTemplateCorsPolicy";
        public const string AuthCorsOriginSettingName = "AuthCorsOrigin";
